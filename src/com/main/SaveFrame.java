...
public class SaveFrame extends javax.swing.JFrame {
	...
	private SavingListener kaydetmeListener;
	...
	*/
    ...
    public void setKaydetmeListener(SavingListener kaydetmeListener) {
		this.kaydetmeListener = kaydetmeListener;
	}
    public SavingListener getKaydetmeListener() {
		return kaydetmeListener;
	}
    
    private void btnKaydetMousePressed(MouseEvent evt) {
    	
    	SavingEventObject obj = new SavingEventObject(this, txtIsim.getText(), txtSoyad.getText(), Integer.valueOf(txtNo.getText()) );
    	
    	kaydetmeListener.saved(obj);
    	this.dispose();
    }
